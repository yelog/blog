...
出现一下画面，就说明安装成功了。
![nexus](https://cdn.jsdelivr.net/gh/yelog/assets/images/FkIlJRDdMC2yJFT9huIk9gBuCe15.png)

## 发布soul项目到私服
### 创建仓库
1. 创建yelog-release仓库（*名字自定义*）, type选择 ： release
![①.创建宿主仓库](https://cdn.jsdelivr.net/gh/yelog/assets/images/Fk5UboZXVf4aegz63N4TDrITMh4V.png)
![②.选择hosted类型](https://cdn.jsdelivr.net/gh/yelog/assets/images/FjAz8w445FFeVqDDzLLTLitOkZyV.png)
![③.创建release类型仓库](https://cdn.jsdelivr.net/gh/yelog/assets/images/Ft2u5UPqdAFxldkkwAC2uVBtjDhF.png)
2. 创建yelog-snapshot仓库（*名字自定义*）， type选择 ： snapshot
重复上面 ① 和 ② 步，根据下图选择类型:
![创建snapshot类型仓库](https://cdn.jsdelivr.net/gh/yelog/assets/images/FgX10ufvTV_YUK2vjrdRN3InKN1i.png)

两个都创建完成后，效果如下：
![创建自定义release和snapshot仓库](https://cdn.jsdelivr.net/gh/yelog/assets/images/FjcMrajAM3anymLemHA2OoZZUut-.png)
...
### 执行maven命令部署项目到私服上
我这里直接使用IDE的插件执行
![部署项目到私服](https://cdn.jsdelivr.net/gh/yelog/assets/images/Frs7jSIClJvF31AnyAAz5JXL-IAP.png)
部署完成后，可以在 yelog-snapshot 仓库中，查看部署的情况，如下图所示
![查看部署情况](https://cdn.jsdelivr.net/gh/yelog/assets/images/Fi1YtOKOAK7KMigjAc4S7ZfwLLjl.png)
...
![public库设置成员仓库](https://cdn.jsdelivr.net/gh/yelog/assets/images/FlmsId2u1z_vQ__zlfzoAIytujm3.png)
2. 配置远程仓库为私服地址。
```xml
<repositories>
    <repository>
...
```
4. ssm项目就可以引用到soul代码
![在代码中就可以直接引用到部署到私服的soul项目代码](https://cdn.jsdelivr.net/gh/yelog/assets/images/FvVCRBtMwy5ckbase3E3wM9JUXp6.png)
