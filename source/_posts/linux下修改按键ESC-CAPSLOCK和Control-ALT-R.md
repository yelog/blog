...
![通过xev获取右alt的keysym](https://cdn.jsdelivr.net/gh/yelog/assets/images/FvuqjLi5czeBluMTyIfv_xUOcu5k.png)

②. 查看 `Alt_R` 是哪个 modifier 使用的
通过 `xmodmap -pm` 查看，发现 `Alt_R` 是作为 modifier `mod1` 使用的。如下图所示：
![查看 Alt_R 是作为 mode1 使用的](https://cdn.jsdelivr.net/gh/yelog/assets/images/Fib8QjT-Ccx30DCf2rF4WkzHsbOH.png)
